% Test wrapper — compiles all 5 agent close-up fragments
\documentclass[11pt]{article}
\usepackage[margin=0.5in, paperwidth=8.5in, paperheight=55in]{geometry}
...
\input{closeup_biomarkerkg}

\input{closeup_pubmed}

\input{closeup_google}

\input{closeup_scientists}

\input{closeup_author_kb}
